    ...
    <section className="gallery-section">
      <div className="parent">
        <div className="div1" onClick={() => openModal((indexBase + 0) % imagenes.length)}>
          <img src={getImg(0).url} alt={getImg(0).titulo} className="image-tile" loading="lazy" />
        </div>
        <div className="div2" onClick={() => openModal((indexBase + 1) % imagenes.length)}>
          <img src={getImg(1).url} alt={getImg(1).titulo} className="image-tile" loading="lazy" />
        </div>
        <div className="div3" onClick={() => openModal((indexBase + 2) % imagenes.length)}>
          <img src={getImg(2).url} alt={getImg(2).titulo} className="image-tile" loading="lazy" />
        </div>
